...
$JBOSS_HOME/bin/jboss-cli.sh -c --user=admin --password=Admin#70365 --command="data-source add --name=MySqlDS --connection-url=jdbc:mysql://localhost:3306/jboss --driver-name=mysql-connector-java-5.1.47.jar --jndi-name=java:jboss/datasources/MySqlDS --user-name=jboss --password=jboss"
